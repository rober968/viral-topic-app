...
# CSS for a clean, mobile-friendly UI on Realme C25s
st.markdown("""
    <style>
...
st.caption("Identify viral outliers and generate content strategies.")
...
with st.sidebar:
    ...
    if "GROQ_API_KEY" in st.secrets:
        ...
        st.warning("⚠️ Key not found in Secrets.")
            ...
            if data:
                ...
                try:
                    ...
                    prompt = (f"Analyze these high-performing YouTube titles: {top_titles}. "
                              "1. Identify the 'Hook'. "
                              "2. Suggest 5 new video titles for History/Business/Psychology. "
...
st.divider()
st.caption("Built for Realme C25s • Powered by Llama 3.1 & yt-dlp")
